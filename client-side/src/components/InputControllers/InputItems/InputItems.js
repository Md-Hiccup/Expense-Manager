    ...
    return (
        <div className={classes.InputItems}>
            ...
            <Form className={classes.form}>
                <Form.Group>
                    <Form.Input size="huge" type="text" name="items"
                        placeholder="Add Items" width={8}
                        value={props.itemList.items} onChange={props.inputChanged}
                    />
                    <Form.Input size="huge" type="number" name="price"
                        placeholder="$ Price" width={3}
                        value={props.itemList.price} onChange={props.inputChanged}
                    />
                    <Button primary size="huge" onClick={props.addItem}>Add</Button>
                    <Button color="green" size="huge" onClick={props.saveItem}>Save</Button>
                </Form.Group>
            </Form>
            {/* <DatePicker
                customInput={<Month />}
